...
export const AuctionCard = ({
    ...
    const [timeToFinnish, setTimeToFinnish] = React.useState<DiferenceTime | null>();
    ...
    useEffect(() => {
        const timeDiference: DiferenceTime | null = getTimeDiference(start_date, end_date);
        if (timeDiference) {
    ...
    }, [creator, end_date, metaMask.account, start_date]);
        ...
        <>
            <div
                ...
                className={`flex flex-col w-[400px] ${
                    owner ? "border-primary border-[3px]" : "border-grey-100 border-[0.25px]"
