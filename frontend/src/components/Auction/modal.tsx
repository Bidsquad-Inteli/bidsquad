...
export const AuctionModal = ({
  ...
  useEffect(() => {
    ...
    if (auction.creator == metaMask.account) setOwner(true);
        ...
        <div className="flex flex-col w-full px-4 justify-between pb-4 py-4">
          <div className="flex flex-col md:flex-row w-full md:px-12 items-center">
            <div className="flex flex-col h-full w-full md:w-2/3">
              ...
              <label className="text-md mt-2 text-gray-400">
                {auction.description}
              </label>
              ...
              <div className="flex flex-col w-full mt-4">
                ...
                <div className="mb-2 flex flex-col">
                  ...
                  <label className="font-medium text-2xl">
                    {fromUnixTime(auction.start_date)}
                  </label>
                </div>
          ...
          {bids && (
            <div className="mt-4 w-full flex flex-col">
              ...
              {bids.map((bid: BidsData, key: number) => (
                <BidList
                  key={key}
                  unique={key}
                  owner={bid.author}
